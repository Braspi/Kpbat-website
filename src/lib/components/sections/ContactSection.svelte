...
<section id="contact" class="px-4 sm:px-8 md:px-12 lg:px-16 my-16">
  <div class="flex flex-col lg:flex-row gap-6 mb-10">
    <div class="flex-1 flex flex-col items-start justify-start">
      <a
          href="mailto:k.p.batiment@gmail.com"
          class="mb-4 flex items-center gap-2 text-sm sm:text-md font-medium bg-black text-white px-4 sm:px-6 py-2 rounded hover:bg-gray-800 transition"
          aria-label={$_('contact.title')}
      >
  ...
  <div class="pt-12">
    <div class="flex flex-col md:flex-row justify-between items-center gap-8 md:gap-4">
      <div class="flex flex-col justify-center h-auto md:h-[200px] rounded-[40px] w-full md:w-1/2">
        ...
        <button
            class="text-left text-base sm:text-lg w-fit cursor-pointer bg-black text-white px-4 sm:px-6 my-4 py-3 rounded hover:bg-gray-800 transition"
