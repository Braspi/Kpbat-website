...
<div class="w-full bg-dark text-light relative h-128 sm:h-52 md:h-72" >
    ...
    <div class="flex flex-col items-center absolute text-lg right-[15%] top-[10%] sm:flex-row sm:right-[30%] sm:top-[28%] sm:gap-4 md:text-2xl md:right-[29%] md:top-[32%] lg:right-[29%] lg:top-[35%] lg:gap-14 xl:text-3xl xl:right-[35.6%]">
    ...
    <hr class="absolute left-1/2 -translate-x-1/2 border-t-2 w-[85%] top-[47%] sm:w-[91%] sm:top-[65%] md:top-[75%]">
        <div class="absolute left-1/2 -translate-x-1/2 text-ms bottom-24 font-medium text-center sm:text-left sm:left-[36%] sm:bottom-4 sm:text-xs sm:font-normal">
            <p class="sm:inline-block">+33 6 38 61 77 95</p>
            <p class="sm:inline-block">contact@kpbat.com</p>
            <div class="text-center mt-1 text-xs sm:mt-0 sm:text-left">
                ...
                <p class="font-medium mt-3 sm:mt-0 sm:inline-block md:block">SIREN - 898 355 763</p>
            </div>
        </div>
    <div class="absolute left-1/2 -translate-x-1/2 font-medium text-center text-xs w-[60%] bottom-8 sm:left-[75%] sm:text-end sm:w-[40%]">
        <p class="">&copy; 2022 - { new Date().getFullYear() } KP BAT. All Rights Reserved Design and code - <a
            href="https://ycode.ovh" class="underline">ycode.ovh</a></p>
    </div>
</div>